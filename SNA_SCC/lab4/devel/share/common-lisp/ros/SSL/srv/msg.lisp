...
(cl:defmethod cl:initialize-instance :after ((m <msg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SSL-srv:<msg-request> is deprecated: use SSL-srv:msg-request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SSL-srv:request-val is deprecated.  Use SSL-srv:request instead.")
  (request m))
...
(cl:defmethod cl:initialize-instance :after ((m <msg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SSL-srv:<msg-response> is deprecated: use SSL-srv:msg-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <msg-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SSL-srv:response-val is deprecated.  Use SSL-srv:response instead.")
  (response m))
